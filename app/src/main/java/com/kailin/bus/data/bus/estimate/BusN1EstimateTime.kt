...
data class BusN1EstimateTime(
        @SerializedName("PlateNumb") val plateNumb: NameType? = NameType(),
        ...
        @SerializedName("SubRouteUID") val subRouteUID: String? = "",
        @SerializedName("SubRouteID") val subRouteID: String? = "",
        @SerializedName("SubRouteName") val subRouteName: NameType? = NameType(),
        @SerializedName("Direction") val direction: Direction? = Direction.UNKNOWN,
        @SerializedName("EstimateTime") val estimateTime: Int? = 0,
        @SerializedName("StopCountDown") val stopCountDown: Int? = 0,
        @SerializedName("CurrentStop") val currentStop: String? = "",
        @SerializedName("DestinationStop") val destinationStop: String? = "",
        @SerializedName("StopSequence") val stopSequence: Int? = 0,
        @SerializedName("StopStatus") val stopStatus: BusStopStatus? = BusStopStatus.TODAY_OFF,
        @SerializedName("MessageType") val messageType: String? = "",
        @SerializedName("NextBusTime") val nextBusTime: Date? = Date(),
        @SerializedName("IsLastBus") val isLastBus: Boolean? = false,
        @SerializedName("DataTime") val dataTime: Date? = Date()
) {
